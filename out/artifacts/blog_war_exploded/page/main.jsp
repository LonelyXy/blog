...
<div class="container" id="main">
    ...
    <div class="row c_center">
        <div class="col-md-3" id="left_content">
            <!-- blog标题 -->
            <div id="title">
                <h2><a href="LoginOutServlet">MyBlog</a></h2>
            ...
            <div class="c_center" id="person_info">
                ...
                <h4 class="text-muted">XyLonely</h4>
            ...
            <div class="c_center">
                <!-- 点击日志按钮跳转到index.jsp -->
                <div class="inline ">
                    <a href="index.jsp">${article_number}<br/>日志</a>
                </div>
            ...
            <div class="sort">
                <div class="list-group">
                    ...
                    <c:forEach var="entity" items="${sort_count_map}">
                        <a href="SortServlet?get=${entity.key}" class="list-group-item">${entity.key}&nbsp;&nbsp;&nbsp;&nbsp;
                            (${entity.value})</a>
                    </c:forEach>
                </div>
            </div>
            ...
            <div class="visit">
                <div class="list-group">
                    ...
                    <c:forEach var="a" items="${visit_rank}">
                        <a href="ArticleServlet?id=${a.id}" class="list-group-item">${a.title}&nbsp;&nbsp; <span
